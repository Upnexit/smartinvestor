  ...
  return (
    <footer className="border-t border-slate-200 bg-white px-4 py-8 sm:px-6">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-6 text-center">
        ...
        {/* Button-styled links centered */}
        <div className="flex flex-wrap items-center justify-center gap-2.5">
          <Link
            to="/privacy"
            className="rounded-full bg-slate-100 px-4 py-2 text-sm text-slate-700 shadow-sm ring-1 ring-slate-200 transition hover:bg-amber-50 hover:text-amber-700 hover:ring-amber-200"
          >
            প্রাইভেসি পলিসি
          </Link>
          <Link

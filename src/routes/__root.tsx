...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Smart Click BD" },
      { title: "Smart Click BD — লাইক কমেন্ট করে টাকা ইনকাম" },
      { name: "description", content: "ঘরে বসে লাইক ও কমেন্ট করে আয় করার বিশ্বস্ত বাংলাদেশী প্ল্যাটফর্ম।" },
      { property: "og:title", content: "Smart Click BD — লাইক কমেন্ট করে টাকা ইনকাম" },
      { property: "og:description", content: "ঘরে বসে লাইক ও কমেন্ট করে আয় করার বিশ্বস্ত বাংলাদেশী প্ল্যাটফর্ম।" },
